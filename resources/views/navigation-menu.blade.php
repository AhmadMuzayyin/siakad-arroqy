<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                    ...
                    @can('view-any', App\Models\StudentClass::class)
                        <x-dropdown-link href="{{ route('student-classes.index') }}">
                            Kelas
                        </x-dropdown-link>
                    @endcan
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @can('view-any', App\Models\Semester::class)
                <x-jet-responsive-nav-link href="{{ route('semesters.index') }}">
                    Semester
                </x-jet-responsive-nav-link>
            @endcan
            @can('view-any', App\Models\StudentClass::class)
                <x-jet-responsive-nav-link href="{{ route('student-classes.index') }}">
                    Kelas
                </x-jet-responsive-nav-link>
            @endcan
            @can('view-any', App\Models\Teacher::class)
                <x-jet-responsive-nav-link href="{{ route('teachers.index') }}">
                    Guru
                </x-jet-responsive-nav-link>
            @endcan
            @can('view-any', App\Models\Lesson::class)
                <x-jet-responsive-nav-link href="{{ route('lessons.index') }}">
                    Mata Pelajaran
                </x-jet-responsive-nav-link>
            @endcan
            @can('view-any', App\Models\HomeroomTeacher::class)
                <x-jet-responsive-nav-link href="{{ route('homeroom-teachers.index') }}">
                    Wali Kelas
                </x-jet-responsive-nav-link>
            @endcan
            @can('view-any', App\Models\TimeTable::class)
                <x-jet-responsive-nav-link href="{{ route('time-tables.index') }}">
                    Jadwal
                </x-jet-responsive-nav-link>
            @endcan
            @can('view-any', App\Models\Student::class)
            ...
            @endcan
            @can('view-any', App\Models\Raport::class)
                <x-jet-responsive-nav-link href="{{ route('raports.index') }}">
                    Raport
                </x-jet-responsive-nav-link>
            @endcan
            @can('view-any', App\Models\User::class)
